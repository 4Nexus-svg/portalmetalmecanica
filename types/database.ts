export type Database = {
  public: {
    Tables: {
      ...
      posts: {
        Row: { id: number; slug: string; title: string; content: string | null; excerpt: string | null; featured_image: string | null; category: string | null; region: string | null; author_id: string | null; published_at: string | null; is_exclusive: boolean; created_at: string };
        Insert: { slug: string; title: string; content?: string | null; excerpt?: string | null; featured_image?: string | null; category?: string | null; region?: string | null; author_id?: string | null; published_at?: string | null; is_exclusive?: boolean };
        Update: { slug?: string; title?: string; content?: string | null; excerpt?: string | null; featured_image?: string | null; category?: string | null; region?: string | null; published_at?: string | null; is_exclusive?: boolean };
      };
      classifieds: {
