export type Database = {
  public: {
    Tables: {
      ...
      classifieds: {
        Row: { id: number; user_id: string; title: string; description: string | null; price: number | null; photos: string[] | null; city: string | null; state: string | null; category: string | null; status: "pending" | "active" | "expired" | "paid"; expires_at: string | null; payment_intent_id: string | null; created_at: string; phone: string | null; whatsapp: string | null };
        Insert: { user_id: string; title: string; description?: string | null; price?: number | null; photos?: string[] | null; city?: string | null; state?: string | null; category?: string | null; status?: "pending" | "active" | "expired" | "paid"; expires_at?: string | null; payment_intent_id?: string | null; phone?: string | null; whatsapp?: string | null };
        Update: { title?: string; description?: string | null; price?: number | null; photos?: string[] | null; city?: string | null; state?: string | null; category?: string | null; status?: "pending" | "active" | "expired" | "paid"; expires_at?: string | null; payment_intent_id?: string | null; phone?: string | null; whatsapp?: string | null };
      };
      subscriptions: {
